        ...
        <footer className='w-full h-[150px] static  bottom-0 grid place-items-center rounded-t-full blured border-t '>
            <section className='w-[70%] flex justify-between items-center'>
                ...
                <section className=' w-[70%] flex justify-end gap-[30px] items-center'>
                    ...
                    <a className='hover:animate-bounce duration-150 w-[70px] h-[70px] grid place-items-center cursor-auto' href="https://www.linkedin.com/in/vitaliy-mejzer-778735326/" target='blank'>
                    ...
                    <a className='hover:animate-bounce duration-150 w-[70px] h-[70px] grid place-items-center cursor-auto' href="https://www.instagram.com/mvitalik_/" target='blank'>
                    ...
                    <a className='hover:animate-bounce duration-150 w-[70px] h-[70px] grid place-items-center cursor-auto' href="https://web.telegram.org/k/#@wnckxv" target='blank' >
                    ...
                    <a className='hover:animate-bounce duration-150 w-[70px] h-[70px] grid place-items-center cursor-auto' href="tel:+380636007473">
                    ...
                    <a className='hover:animate-bounce duration-150 w-[70px] h-[70px] grid place-items-center cursor-auto' href="mailto:mejzervitalik@gmail.com" target='blank'>
